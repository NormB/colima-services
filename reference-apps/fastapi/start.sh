...
#
# Description:
#   Starts the FastAPI reference application with dual HTTP/HTTPS support.
...
#   REFERENCE_API_ENABLE_TLS - TLS enablement flag from init.sh
#   CERT_DIR               - Certificate directory path (default: /etc/ssl/certs/reference-api)
#   HTTP_PID               - Modified: Process ID of HTTP server
#   HTTPS_PID              - Modified: Process ID of HTTPS server
#
# Usage:
#   ./start.sh
#   HTTP_PORT=9000 HTTPS_PORT=9443 ./start.sh
#   REFERENCE_API_ENABLE_TLS=true ./start.sh
#
# Dependencies:
...
#   REFERENCE_API_ENABLE_TLS=true CERT_DIR=/path/to/certs ./start.sh
#
#######################################
...
TLS_ENABLED=${REFERENCE_API_ENABLE_TLS:-false}
CERT_DIR=${CERT_DIR:-/etc/ssl/certs/reference-api}
...
main() {
    echo ""
    echo "========================================="
    echo "  FastAPI Reference Application"
    echo "========================================="
    echo ""
