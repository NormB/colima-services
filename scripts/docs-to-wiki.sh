...
echo ""
echo -e "${BLUE}➕ Syncing Additional Docs...${NC}"
if [ -f "$DOCS_DIR/AUTOMATION_INFRASTRUCTURE_DESIGN.md" ]; then
    sync_file "$DOCS_DIR/AUTOMATION_INFRASTRUCTURE_DESIGN.md" "Migration-Guide" "Migration Guide"
fi
if [ -f "$DOCS_DIR/VOIP_INFRASTRUCTURE_ANALYSIS.md" ]; then
    sync_file "$DOCS_DIR/VOIP_INFRASTRUCTURE_ANALYSIS.md" "Backup-and-Restore" "Backup and Restore"
fi
